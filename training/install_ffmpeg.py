# we installed this on our local machine, but when we will train our model on the cloud, the cloud does not have ffmpeg installed
#so we will install ffmpeg on the cloud using this script
