...
#THE MAIN GOAL OF THIS ENTIRE CODE IS TO PREPARE THE DATA . HOW ? BY ENCODIING THE TRANSCRIBED TEXT OF CSV USING BERT AND CONVERTING TO TENSOR,
#EXTRACTING THE 30 VIDEO FRAMES FROM A VIDEO FILE AND CONVERTING THEM TO TENSOR OF FORMAT [30 FRAMES, 3 CHANNELS, 224 HEIGHT, 224 WIDTH],
#AND EXTRACTING AUDIO FEATURES FROM THE VIDEO FILE AND CONVERTING TO TENSOR , 
#AND MAPPING THE EMOTION AND SENTIMENT LABELS
#AND CONCATENATING THEM ALL INTO A SINGLE DICTIONARY FOR EACH SAMPLE.
